...
if (!isset($_SESSION['registration_success']) || !isset($_SESSION['mca_code'])) {
    header('Location: registration.php');
    exit;
}

$mca_code = $_SESSION['mca_code'];
$tracking_code = $_SESSION['tracking_code'];
$user_id = $_SESSION['user_id'];
$registration_fee = $_SESSION['registration_fee'] ?? 59.00;
$enterprise_package = isset($_SESSION['enterprise_package']) ? 959.00 : 0;
$total_amount = $registration_fee + $enterprise_package;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment'])) {
    ...
    if (empty($payment_method)) {
        ...
        try {
            ...
            // Update MCA agent with payment information
            $stmt = $db->prepare("
                UPDATE mca_agents 
            ...
            $stmt = $db->prepare("
                ...
                ) VALUES (?, 'mca_registration', ?, ?, ?, 'completed', ?)
            ");
            $stmt->execute([
                $user_id, $total_amount, $payment_method, $payment_reference,
                "MCA Registration Fee - Code: {$mca_code}"
            ]);
            ...
            unset($_SESSION['mca_code']);
            unset($_SESSION['tracking_code']);
            unset($_SESSION['user_id']);
            unset($_SESSION['registration_fee']);
            
            // Set success message
            $_SESSION['payment_success'] = true;
            $_SESSION['new_mca_code'] = $mca_code;
...
$page_title = 'MCA Registration Payment - Forever Young Tours';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="auth-container">
        <div class="auth-header">
            ...
            <h1>Complete Your MCA Registration</h1>
        ...
        <div class="payment-container">
            <div class="registration-summary">
                ...
                <p>Your MCA Code:</p>
                <div class="mca-code"><?php echo htmlspecialchars($mca_code); ?></div>
            ...
            <div class="amount-breakdown">
                ...
                <div class="amount-row">
                    <span>MCA Registration Fee:</span>
                    <span>$<?php echo number_format($registration_fee, 2); ?></span>
                </div>
                <?php if ($enterprise_package > 0): ?>
                <div class="amount-row">
                    <span>MCA Enterprise Package:</span>
                    <span>$<?php echo number_format($enterprise_package, 2); ?></span>
                </div>
                <?php endif; ?>
            ...
            <form method="POST">
                ...
                <div id="bank_transfer_details" class="payment-details">
                    ...
                    <p><strong>Reference:</strong> MCA-<?php echo $mca_code; ?></p>
                </div>
                
                <div id="mobile_money_details" class="payment-details">
                    <h4>Mobile Money Details</h4>
                    <p><strong>MTN Mobile Money:</strong> *182*8*1*<?php echo $total_amount; ?>*250788123456#</p>
                    <p><strong>Airtel Money:</strong> *185*9*<?php echo $total_amount; ?>*250733123456#</p>
                    <p><strong>Reference:</strong> MCA-<?php echo $mca_code; ?></p>
                </div>
                ...
                <div id="paypal_details" class="payment-details">
                    ...
                    <p><strong>Amount:</strong> $<?php echo number_format($total_amount, 2); ?> USD</p>
                    <p><strong>Reference:</strong> MCA-<?php echo $mca_code; ?></p>
                </div>
                ...
                <div id="crypto_details" class="payment-details">
                    ...
                    <p><strong>Amount:</strong> $<?php echo number_format($total_amount, 2); ?> USD equivalent</p>
                    <p><strong>Reference:</strong> MCA-<?php echo $mca_code; ?></p>
                </div>

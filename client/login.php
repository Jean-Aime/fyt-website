    ...
    if (empty($email) || empty($password)) {
        ...
        if ($user && password_verify($password, $user['password_hash'])) {
            ...
            if ($user['role_name'] === 'admin' || $user['role_name'] === 'super_admin') {
                $redirect = '/webtour/admin/dashboard.php';
            } elseif ($user['role_name'] === 'mca_agent') {
                $redirect = '/webtour/mca/dashboard.php';
            } elseif ($user['role_name'] === 'client') {
                $redirect = '/webtour/client/dashboard.php'; // ✅ FIXED
            } else {
                $redirect = '/webtour/index.php'; // Optional fallback
            }
